const FETCHED_COURSES = {
    ...
    '__CURVE_SERVICE__ITEPC 05': {
        title: 'Curve and Surface Reconstruction from Point Samples',
        description: 'With the advancement of 3D scanning technology, it is becoming popoular to represent a physical object by scanning a dense set of point samples on its boundary. The next step is to recreate a computer representation of the object from this set of point samples. This is known as the curve reconstruction problem in 2D and the surface reconstruction problem in 3D. In 2D the output desired is a polygonal curve connecting the input point samples. The polygonal curve should be a faithful representation of the topology and geometry of the unknown curve. In 3D the output desired is a polygonal surface composed of triangles. In this project students will learn two simple and powerful algorithms for curve and surface reconstruction. Ultimately they will implement these two algorithms to demonstrate their effectiveness and render the reconstructed results using some standard user interface tools.',
    }
};
