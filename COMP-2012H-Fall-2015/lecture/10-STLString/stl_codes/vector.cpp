...
int main()
{
  ...
  integers.push_back( 2 );  // push 2 to the end of the vector integers
  integers.push_back( 3 );  // push 3 to the end of the vector integers
  ...
  vector< int >::const_reverse_iterator reverseIterator; // constant iterator: element pointed to not to be modified
  vector< int >::const_reverse_iterator tempIterator = integers.rend();

  // display vector in reverse order using reverse_iterator
  // use rbegin and rend member functions
...
{
  // const_iterator: element accessor; class can be typename
  class vector< T >::const_iterator constIterator; 
