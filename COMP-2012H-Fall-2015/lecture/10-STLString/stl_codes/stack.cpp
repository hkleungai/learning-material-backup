...
// T has to be a stack as input parameter
template< typename T > void pushElements( T &stackRef );

// popElements function-template prototype
// a better implementation because it explicitly shows that
// the input is a stack with possibly two template parameters
template< typename T, typename cl >
void popElements( stack<T, cl> &stackRef );
