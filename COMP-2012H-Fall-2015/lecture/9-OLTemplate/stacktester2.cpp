...
// function template to work on a class template
// keep pushing elements with fixed increment into stack until it is full
// then pop things out
//
template< typename T >                                         
void testStack(                                             
...
{                                                           
  ...
  while ( theStack.push( value ) )                         
    {                                                        
      cout << value << ' ';  // need to overload << for class object
      value += increment;    // need to overload operator+ for class object
    } // end while                                           
