...
int main()
{
   ...
   GradeBook gradeBook1( "COMP2011 Introduction to C++" );
   GradeBook gradeBook2( "COMP2012 OOP and Data Structures" );
   GradeBook gradeBook3;  // default
   //   GradeBook gradeBook4();  // A function prototype, NOT a constructor
                                 // Use instead GradeBook gradeBook4(""); 
