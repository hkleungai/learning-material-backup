...
for i in range(1, epoch_nums+1):
    ## training
    ## when you have norm layer or dropout layer, please call model.train() when training
    ##  to ensure it behaves correctly, and set it to eval mode when testing by call model.eval().
    net.train()
