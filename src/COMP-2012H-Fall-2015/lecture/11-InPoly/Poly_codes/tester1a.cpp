...
#include "BasePlusCommissionEmployee1.h" 
...
int main()
{
  ...
  /* compiler error as commissionEmployeePtr only has base class scope;
     getBaseSalary is of derived class:
     commissionEmployeePtr->getBaseSalary(); */
