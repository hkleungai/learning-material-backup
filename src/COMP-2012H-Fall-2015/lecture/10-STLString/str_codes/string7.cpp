...
int main()
{
  ...
  while ( position != string::npos ) 
    {
      string1.replace( position, 1, "." ); // replace the space by 1 occurence of dot
  ...
  while ( position != string::npos )
    {
      string1.replace( position, 2, "xxxxx;;yyy", 5, 2 ); // replace 2 characters using the string xxxxx;;yyy
      position = string1.find( ".", position + 1 );
    } // end while
