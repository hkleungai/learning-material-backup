...
int main()
{
  ...
  // comparing string1 (starting element at position 2 for a total of 5 characters) and string3 (starting element at the first position for a total of 5 characters)
