...
class Time;  // need to put this prototype here to help compiler to 
             // understand the following operator overload statement with Time
...
class Time
{
 ...
 /********** Data Members **********/
   ...
   unsigned myMilTime;   // military time equivalent; unsigned is the same as unsigned int
